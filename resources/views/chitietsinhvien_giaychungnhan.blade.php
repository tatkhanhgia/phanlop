...
<div class="col-lg-12">
	<section class="panel">
		...
		<div class="panel-body" style="display: block;">
			<div class="form">            
				<form class="cmxform form-horizontal " id="signupForm" method="post" action="{{URL::to('/quaylaidanhsach')}}" novalidate="novalidate">
					{{ csrf_field() }}
					...
					<input type ="hidden" id="khoathi" name = "khoathi" value="{{$row[12]}}">
						<input type ="hidden" id="phongthi" name="phongthi" value="{{$row[11]}}">	
						<button type="submit" class="btn btn-warning" style="font-size: 14px; margin-top: 5px; width: 100px;height: 40px" id="add_position"><i class="fas fa-arrow-circle-left">Quay lại</i></button></a>
					</form>							
					<form method="post" action="{{URL::to('/giaychungnhan_in')}}">
                        {{ csrf_field() }}
							<input type ="hidden" id="khoathi" name = "khoathi" value="{{$row[12]}}">
							<input type ="hidden" id="sbd" name="sbd" value="{{$row[0]}}">
                            <button class="btn btn-danger btn-sm" style="font-size: 14px; margin-top: 5px; width: 100px;height: 40px" title="In giấy" name="id"  id="id" type="submit">In giấy</button>
                    </form>                                              	
