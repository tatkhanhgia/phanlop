				...
				<form class="cmxform form-horizontal " id="signupForm" method="post" action="{{URL::to('pages/5/add_detail_save')}}"  >
					...
					<div class="form-group ">
						...
						<div class="col-lg-6 col-sm-9">
                            <input class=" form-control" type="text" id="datepicker" name="datepicker" value="<?php echo $arrayMate[3]?>" readonly="readonly">
						</div>
					</div>
                    @foreach($arrayMate[4] as $row)
                    ...
                    <!--<div class="form-group " id = "thaiphien" style="display:block">						-->
						<tr>                            
                            ...
                            @if($row[0] == 1)
                                <?php $quantity = $row[1]; $total = $row[2]; ?>
                            @else
                                <?php $quantity = 0; $total = 0; ?>
                            @endif
							<td><label ><input class=" form-control" type="text" id="1" name="1" pattern="[0-9.]*" required value="<?php echo $quantity ?>"></label></td>
							<td><label ><input class=" form-control" type="text" id="20" name="20" pattern="[0-9.]*" required value="<?php echo $total ?>"></label></td>
						</tr>
						<tr>
                            @if($row[0] == 2)
                                <?php $quantity = $row[1]; $total = $row[2]; ?>
